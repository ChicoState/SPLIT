...
import 'package:split/shared/loading.dart';
    ...
    return loading
        ...
        : Scaffold(
            ...
            appBar: AppBar(
              ...
              elevation: 0.0,
              title: const Text('Sign In to SPLIT'),
              actions: <Widget>[
                //button that switches between sign in and register
                FlatButton.icon(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      TextFormField(
                          ...
                          obscureText: true,
                          validator: (String? val) {
                            //making sure the password form is filled
